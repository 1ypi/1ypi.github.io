...
const interactiveElements = document.querySelectorAll('button, .social-icon, .skill-card, .discord-container, a, input, textarea, select');
...
function showBootPrompt() {
    ...
    promptLine.innerHTML = 'Boot system? (Y/n): <span class="boot-cursor">_</span>';
    ...
    document.querySelectorAll('.virtual-key').forEach(key => {
        key.addEventListener('click', function() {
            ...
            const cursor = promptLine.querySelector('.boot-cursor');
            if (cursor) {
                cursor.remove();
            }
    ...
    function handleKeyPress(e) {
        ...
        if (e.key === 'Enter') {
            ...
            promptLine.innerHTML = `Boot system? (Y/n): ${userInput}<span class="boot-cursor">_</span>`;
